...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    private void seedData() {
        System.out.println("Seeding database with sample data...");
                ...
                List<Long> seededOfficeIds = new ArrayList<>();
        ...
        seededOfficeIds.add(registerAndApprove(partner4, "HSBC Philippines", "Bank & Finance", "BANKING",
        ...
        seededOfficeIds.add(registerAndApprove(partner5, "UnionBank of the Philippines - Cebu IT Park", "Bank & Finance", "BANKING",
        ...
        seededOfficeIds.add(registerAndApprove(partner6, "BPI Cebu Main Branch", "Bank & Finance", "BANKING",
        ...
        seededOfficeIds.add(registerAndApprove(partner7, "Philippine Savings Bank - Cebu Uptown", "Bank & Finance", "BANKING",
        ...
        seededOfficeIds.add(registerAndApprove(partner8, "UnionBank Insular Building", "Bank & Finance", "BANKING",
        ...
        seededOfficeIds.add(registerAndApprove(partner9, "Affinity Dental Clinics Cebu", "Dental Clinic", "DENTAL",
        ...
        seededOfficeIds.add(registerAndApprove(partner10, "D&G Dental Clinic", "Dental Clinic", "DENTAL",
        ...
        seededOfficeIds.add(registerAndApprove(partner11, "Cebu Dental Care Center", "Dental Clinic", "DENTAL",
        ...
        seededOfficeIds.add(registerAndApprove(partner12, "Metro Dental SM City Cebu", "Dental Clinic", "DENTAL",
        ...
        seededOfficeIds.add(registerAndApprove(partner13, "Green Apple Dental Clinic Cebu", "Dental Clinic", "DENTAL",
        ...
        seededOfficeIds.add(registerAndApprove(partner14, "Cebu Doctors' University Hospital", "Hospital", "HOSPITAL",
        ...
        seededOfficeIds.add(registerAndApprove(partner15, "St. Vincent General Hospital Cebu", "Hospital", "HOSPITAL",
        ...
        seededOfficeIds.add(registerAndApprove(partner16, "Adventist Hospital Cebu", "Hospital", "HOSPITAL",
        ...
        seededOfficeIds.add(registerAndApprove(partner17, "VisayasMed Hospital", "Hospital", "HOSPITAL",
        ...
        seededOfficeIds.add(registerAndApprove(partner18, "Cebu City Hall", "Government Office", "GOVERNMENT",
        ...
        seededOfficeIds.add(registerAndApprove(partner19, "Office of the Building Official", "Government Office", "GOVERNMENT",
        ...
        seededOfficeIds.add(registerAndApprove(partner20, "Human Resource Development Office Cebu City", "Government Office", "GOVERNMENT",
        ...
        seededOfficeIds.add(registerAndApprove(partner21, "Public Services Office Cebu City", "Government Office", "GOVERNMENT",
                "Ramos Area, Cebu City",
                10.3080, 123.8965, "+63 32 255 2814"));

        seedQueueTickets(seededOfficeIds);
    ...
    // ── Helper: Register an office and immediately approve it ──
        private Long registerAndApprove(User owner, String name, String category, String type,
        ...
        Map<String, Object> result = queueFacade.registerOffice(owner.getId(), req);
                Long officeId = Long.valueOf(result.get("officeId").toString());
                queueFacade.approveOfficeRegistration(officeId);
        System.out.println("  ✅ " + name + " — owned by " + owner.getEmail());
                return officeId;
    }

        private void seedQueueTickets(List<Long> officeIds) {
                ...
                for (int i = 0; i < officeIds.size(); i++) {
                        ...
                        for (int j = 0; j < targetCount; j++) {
                                String email = String.format("queueuser%03d@example.com", userCounter);
                                User user = new User();
                                user.setName("Queue User " + userCounter);
                                user.setEmail(email);
                                ...
                                try {
                                        queueFacade.joinQueue(user.getId(), officeIds.get(i));
                                } catch (RuntimeException e) {
                                        System.out.println("  ⚠️ Unable to seed queue ticket for " + email + ": " + e.getMessage());
                                }
